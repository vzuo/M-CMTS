...
print "#Please verify the file like 'apex_rf_port_ots_conf_for_dx1hw_cg_slot_6_0_24channels.txt' has been generated in the output folder in APP7 server!"

print "#Please verify the apex3000 qam name is right in above file!"

print "*******************************************************************************************************************************"

device_name = raw_input('Input M-CMTS name(eg. dx1hw.cg):\n').strip()
